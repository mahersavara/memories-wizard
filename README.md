...
- `MemoriesWizard/`: Windows source code (C# WPF).
- `macOS/`: macOS source code (SwiftUI).
- `InternalTests/`: Automated logic verification suite.
- `Publish/Windows/`: Contains the standalone portable executable.

## 🚀 Installation & Running

### Windows
1. Go to `Publish/Windows/`.
